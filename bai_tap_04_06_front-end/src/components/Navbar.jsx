    ...
    <nav className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-md backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        <Link to="/" className="flex items-center gap-3 text-blue-700">
          ...
          <span className="hidden text-xl font-extrabold tracking-wide sm:block">UniCinema</span>
        </Link>

        <div className="mx-8 hidden flex-1 md:flex">
          <input
            type="text"
            placeholder="Tim phim, rap, suat chieu..."
        ...
        <div className="flex items-center gap-5">
          {isAuthenticated ? (
            <div className="hidden sm:flex items-center gap-3">
              <Link to="/my-tickets" className="font-medium text-slate-700 transition hover:text-blue-600">
                Ve da dat
              </Link>
